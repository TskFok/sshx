        ...
        match key.as_str() {
            ...
            "terminal_dynamic_wallpaper_opacity" => {
                settings.terminal_dynamic_wallpaper_opacity =
                    value.parse().unwrap_or(settings.terminal_dynamic_wallpaper_opacity);
            }
...
pub fn update_settings(
    ...
    let pairs = vec![
        ...
        (
            ...
            settings.terminal_color_scheme.clone(),
        ),
        (
            "terminal_dynamic_wallpaper_path",
            settings.terminal_dynamic_wallpaper_path.clone(),
        ),
        (
            "terminal_dynamic_theme_json",
            settings.terminal_dynamic_theme_json.clone(),
        ),
        (
            "terminal_dynamic_wallpaper_opacity",
